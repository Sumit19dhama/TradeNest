    ...
    <div className="container mt-5">
      <div className="row">
        <div className="col-6 p-5 mt-4">
          <img src="assests/largestBroker.svg" alt="largestBroker" style={{ width: "85%" }}/>
        </div>
        <div className="col-6 p-5 fs-7 mt-2">
          ...
          <img src="assests/pressLogos.png" alt="pressLogo" style={{ width: "90%" }} />
        </div>
      </div>
    </div>
  );
